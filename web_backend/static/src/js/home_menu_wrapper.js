odoo.define("web_backend.HomeMenuWrapper", function (require) {
    "use strict";

    const HomeMenu = require('web_backend.HomeMenu');
            ...
            utils.traversePath(menuData, (menuItem, parents) => {
                ...
                if (!menuItem.parent_id) {
                    ...
                    if (menuItem.web_icon_data) {
                        ...
                        item.webIconData = '/web_backend/static/src/img/default_icon_app.png';
                    }
                } else {
